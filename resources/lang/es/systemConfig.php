...
return[
    ...
    'state.4.body'=>'-Los grupos son autogenerados basados en las matrículas y el máximo número de estudiantes por grupo.<br>-Los <strong>estudiantes</strong> ya no pueden matricularse.<br>-Los <strong>PDIs de administración</strong> pueden asignar el horario y las aulas a los grupos.',
    'state.5.body'=>'-Los <strong>estudiantes</strong> pueden cambiar de grupo ahora.<br>Los grupos no pueden ser modificados ya.',
    'state.6.body'=>'-Los <strong>estudiantes</strong> ya no pueden permutar grupos más.',
    'state.7.body'=>'-Las actas de las asignaturas del primer semestre se autogeneran de los exámenes realizados.<br>-Los <strong>PDIs de Administración</strong> pueden modificar las actas del primer semestre ahora.<br>-Los <strong>estudiantes</strong> no pueden permutar de grupos ya.<br>-Los <strong>PDIs de administración</strong>  no pueden asignar el horario y las aulas a los grupos ya.',
    'state.8.body'=>'-Los <strong>PDIs de Administración</strong> no  pueden modificar las actas.',
