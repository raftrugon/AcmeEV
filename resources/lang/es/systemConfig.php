...
return[
    ...
    'state.2.body'=>'-Segunda y final lista de adjudicaciones computada.<br>-Los <strong>estudiantes</strong> pueden aceptar las adjudicaciones finales.',
    'state.3.body'=>'-Las instancias de las asignaturas y grupos son autogeneradas.<br>-Los nuevos estudiantes son autogenerados en base a las inscripciones aceptadas.<br>-Los <strong>estudiantes</strong> pueden matricularse ahora.<br>-Los <strong>PDIs de administración</strong> no pueden modificar las asignaturas, los grados ni los departamentos ya.<br>-Los <strong>PDIs de administración</strong> pueden asignar el horario y las aulas a los grupos.',
    'state.4.body'=>'-Los <strong>estudiantes</strong> ya no pueden matricularse.<br>',
    'state.5.body'=>'-Las actas de las asignaturas del primer semestre se autogeneran de los exámenes realizados.<br>-Los <strong>profesores</strong> pueden modificar las actas del primer semestre ahora.',
