...
return[
    ...
    'state.6.body'=>'-Los <strong>PDIs de Administración</strong> no  pueden modificar las actas.',
    'state.7.body'=>'-Las actas de las asignaturas del segundo semestre y anuales se autogeneran de los exámenes realizados.<br>-Los <strong>PDIs de Administración</strong> pueden modificar las actas del segundo semestre y de asignaturas anuales ahora.',
    'state.8.body'=>'-Los <strong>PDIs de Administración</strong> no  pueden modificar las actas.<br>-Los <strong>PDIs de administración</strong> pueden modificar las asignaturas, los departamentos y los grados ahora.',
];