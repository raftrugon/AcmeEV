...
return[
    ...
    'state.5.body'=>'-Minutes are autogenerated from Control Checks of Subjects from the first semester.<br>-<strong>Management PDIs</strong> can modify Minutes of subjects from the first semester now.<br>-<strong>Students</strong> cannot exchange groups anymore.<br>-<strong>Management PDIs</strong> cannot set teachers and rooms to groups anymore.',
    'state.6.body'=>'-<strong>Management PDIs</strong> cannot change Minutes anymore.',
    'state.7.body'=>'-Minutes are autogenerated from Control Checks of Subjects from the second semester and annuals.<br>-<strong>Management PDIs</strong> can modify Minutes of subjects from the second semester and annuals now.\'',
    'state.8.body'=>'-<strong>Management PDIs</strong> cannot change Minutes anymore.<br>-<strong>Management PDIs</strong> can modify subjects, departments and degrees now.',
