...
return[
    ...
    'state.5.body'=>'-Minutes are autogenerated from Control Checks of Subjects from the first semester.<br>-<strong>Lecturers</strong> can modify Minutes of subjects from the first semester now.<br>-<strong>Students</strong> cannot exchange groups anymore.<br>-<strong>Management PDIs</strong> cannot set teachers and rooms to groups anymore.',
