                ...
                <div class="card border-info">
                    ...
                    <div class="card-body tab-content">
                        <div class="tab-pane fade show active" id="tab1" data-parent="#accordion">
                            ...
                            <div class="row align-items-end">
                                @include('global.input',['col'=>'6','type'=>'text','id'=>'secretariat_open_time','name'=>'secretariat_open_time','label'=>__('attributes.secretariat_open_time'),'placeholder'=>__('placeholder.time'), 'value'=>isset($system_config) ? $system_config->getSecretariatOpenTime() : null ])
                                @include('global.input',['col'=>'6','type'=>'text','id'=>'secretariat_close_time','name'=>'secretariat_close_time','label'=>__('attributes.secretariat_close_time'),'placeholder'=>__('placeholder.time'), 'value'=>isset($system_config) ? $system_config->getSecretariatCloseTime() : null ])
                            </div>
                            <div class="row align-items-end">
