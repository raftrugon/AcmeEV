                ...
                <div class="card border-info" >
                    <div class="card-header text-center border-info">
                        <ul class="nav nav-pills card-header-pills nav-fill">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="pill" href="#tab1" role="button" aria-expanded="true" aria-controls="tab1"><Strong>@lang('systemConfig.edit.tab1')</Strong></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#tab2" role="button" aria-expanded="false" aria-controls="tab2"><Strong>@lang('systemConfig.edit.tab2')</Strong></a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body tab-content">
                        ...
                        <div class="tab-pane fade" id="tab2" data-parent="#accordion">
                            <div class="row">
                                <button id="first_inscriptions" type="button" class="btn btn-info col-sm-4">@lang('systemConfig.edit.first-inscriptions')</button>
                            </div>
                        </div>
