                ...
                <div class="card border-info" >
                    ...
                    <div class="card-body">
                        @if(isset($controlCheck))
                            ...
                            @include('global.select',['id'=>'room','objects'=>$rooms,'value'=>'id','display'=>'display_name','label'=>__('controlCheck.rooms'),'selectedOption'=>$controlCheck->getRoom->getId()])
                        ...
                        @else
                            ...
                            @include('global.select',['id'=>'room','objects'=>$rooms,'value'=>'id','display'=>'display_name','label'=>__('controlCheck.rooms')])
